...
public class Tile {
    ...
    public static BufferedImage ERROROLD_IMAGE;
    ...
    static {
        try {
            ...
            ERROROLD_IMAGE = ImageIO.read(JMapViewer.class.getResourceAsStream("images/errorold.png"));
        } catch (Exception e1) {
            LOADING_IMAGE = null;
            ERROR_IMAGE = null;
            ERROROLD_IMAGE = null;
    ...
    public void loadPlaceholderFromCache(TileCache cache) {
        BufferedImage tmpImage = new BufferedImage(source.getTileSize(), source.getTileSize(), BufferedImage.TYPE_INT_ARGB);
...
//    public BufferedImage Transparency(BufferedImage image, BufferedImage image2){
