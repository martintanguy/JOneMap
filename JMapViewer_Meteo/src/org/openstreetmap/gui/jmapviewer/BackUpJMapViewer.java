 ...
 *
 */
public class BackUpJMapViewer extends JPanel implements TileLoaderListener {
...
//	private TileController tc8;
     ...
     */
    public BackUpJMapViewer() {
        this(new MemoryTileCache(), 8);
        new DefaultMapController(this);
    }

    public BackUpJMapViewer(TileCache tileCache, int downloadThreadCount) {
        super();
...
//        tileController = new TileController(tileSource, tileCache, this);
        ...
        setDisplayPosition(new Coordinate(48.3262,-4.4256), 14);
    ...
    //    zoomSlider.setOrientation(JSlider.VERTICAL);
        ...
        int size = 18;
        try {
            ImageIcon icon = new ImageIcon(BackUpJMapViewer.class.getResource("images/plus.png"));
        ...
        add(zoomInButton);
        try {
            ImageIcon icon = new ImageIcon(BackUpJMapViewer.class.getResource("images/minus.png"));
