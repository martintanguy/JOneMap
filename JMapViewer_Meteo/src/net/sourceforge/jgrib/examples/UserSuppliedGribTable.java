...
public class UserSuppliedGribTable {
	...
	public static void main(String[] args) {
		...
		if(!grib.exists()) {
			System.out.println("File: "+ grib + "is not found on disk");
			System.exit(0);
		}

        // Test if GRIBTAB file is found on disk
        String gribTabPath = System.getProperty(PROPERTY_GRIBTABPATH);
		File gribTab = new File(gribTabPath);
		if(!gribTab.exists()) {
			System.out.println("File: "+ gribTab + "is not found on disk");
			System.exit(0);
		}
