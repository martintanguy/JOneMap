...
public class SetupLog {
	 ...
	 */
	private static Logger logger = Logger.getLogger(SetupLog.class);
	...
	public static void addJGribDebugInfo() {
		...
		Logger logger = Logger.getLogger("net.sourceforge.jgrib");
		logger.debug("JGRIB debug log initialized");
	}
	...
	public static void main(String[] args) {
		...
		logger.info("Testing info statements");
		logger.warn("Testing warning statements");
		logger.debug("Testing debug statements");
	}
